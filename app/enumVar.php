...
class enumVar {
    ...
    const USER_ADMIN = 2;
    const USER_PM = 3;
    const USER_ADMPROYEK = 4;
    const USER_SUPERVISOR = 5;
    const USER_DESC_SUPERADMIN = "Superadmin";
    const USER_DESC_ADMIN = "Admin";
    const USER_DESC_PM = "Project Manager";
    const USER_DESC_SUPERVISOR = "Supervisor";
    // const USER_NAKER = 3;
    ...
    const CATEGORY_PLUMBING = 1;
    const CATEGORY_PIPE = 2;

    const CATEGORY_DESC_PLUMBING = 'Plumbing';
    const CATEGORY_DESC_PIPE = 'Pipe';

    public function listCategory($name="id") {
        if ($name=="id")
            return array(
        ...
        return array(
            self::CATEGORY_DESC_PLUMBING, 
            self::CATEGORY_DESC_PIPE, 
        );
    }

    const MANPOWER_IDL_PROJECTMANAGER = 1;
    const MANPOWER_IDL_PROJECTENGINEER = 2;
    const MANPOWER_IDL_SUPERVISOR = 3;
    const MANPOWER_IDL_IMSENGINEER = 4;
    const MANPOWER_IDL_QCENGINEER = 5;
    const MANPOWER_IDL_HSESUPERVISOR = 6;
    const MANPOWER_IDL_SAFETYOFFICER = 7;
    const MANPOWER_IDL_EXPEDITOR = 8;
    const MANPOWER_IDL_SITELOGISTIC = 9;
    const MANPOWER_IDL_DRAFTERSUPPORT = 10;
    const MANPOWER_IDL_ADMINPROJECT = 11;

    const MANPOWER_IDL_DESC_PROJECTMANAGER = 'Project Manager';
    const MANPOWER_IDL_DESC_PROJECTENGINEER = 'Project Engineer';
    const MANPOWER_IDL_DESC_SUPERVISOR = 'Supervisor';
    const MANPOWER_IDL_DESC_IMSENGINEER = 'IMS Engineer';
    const MANPOWER_IDL_DESC_QCENGINEER = 'QC Engineer';
    const MANPOWER_IDL_DESC_HSESUPERVISOR = 'HSE Supervisor';
    const MANPOWER_IDL_DESC_SAFETYOFFICER = 'Safety Officer';
    const MANPOWER_IDL_DESC_EXPEDITOR = 'Expeditor';
    const MANPOWER_IDL_DESC_SITELOGISTIC = 'Site Logistic';
    const MANPOWER_IDL_DESC_DRAFTERSUPPORT = 'Drafter Support';
    const MANPOWER_IDL_DESC_ADMINPROJECT = 'Admin Project';


    public function listManpowerIDL($name="id") {
        if ($name=="id")
            return array(
                self::MANPOWER_IDL_PROJECTMANAGER, 
                self::MANPOWER_IDL_PROJECTENGINEER, 
                self::MANPOWER_IDL_SUPERVISOR, 
                self::MANPOWER_IDL_IMSENGINEER, 
                self::MANPOWER_IDL_QCENGINEER, 
                self::MANPOWER_IDL_HSESUPERVISOR, 
                self::MANPOWER_IDL_SAFETYOFFICER, 
                self::MANPOWER_IDL_EXPEDITOR, 
                self::MANPOWER_IDL_SITELOGISTIC, 
                self::MANPOWER_IDL_DRAFTERSUPPORT, 
                self::MANPOWER_IDL_ADMINPROJECT, 
            );
        else
        return array(
            self::MANPOWER_IDL_DESC_PROJECTMANAGER, 
            self::MANPOWER_IDL_DESC_PROJECTENGINEER, 
            self::MANPOWER_IDL_DESC_SUPERVISOR, 
            self::MANPOWER_IDL_DESC_IMSENGINEER, 
            self::MANPOWER_IDL_DESC_QCENGINEER, 
            self::MANPOWER_IDL_DESC_HSESUPERVISOR, 
            self::MANPOWER_IDL_DESC_SAFETYOFFICER, 
            self::MANPOWER_IDL_DESC_EXPEDITOR, 
            self::MANPOWER_IDL_DESC_SITELOGISTIC, 
            self::MANPOWER_IDL_DESC_DRAFTERSUPPORT, 
            self::MANPOWER_IDL_DESC_ADMINPROJECT, 
        );
    }

    const MANPOWER_DL_FOREMAN = 12;
    const MANPOWER_DL_FITTER = 13;
    const MANPOWER_DL_WELDER = 14;
    const MANPOWER_DL_HELPER = 15;
    const MANPOWER_DL_CARPENTER = 16;
    const MANPOWER_DL_FACILITY = 17;
    const MANPOWER_DL_LOGISTICDRIVER = 18;
    const MANPOWER_DL_SCAFFOLDER = 19;

    const MANPOWER_DL_DESC_FOREMAN = 'Foreman';
    const MANPOWER_DL_DESC_FITTER = 'Fitter';
    const MANPOWER_DL_DESC_WELDER = 'Welder';
    const MANPOWER_DL_DESC_HELPER = 'Helper';
    const MANPOWER_DL_DESC_CARPENTER = 'Carpenter';
    const MANPOWER_DL_DESC_FACILITY = 'Facility';
    const MANPOWER_DL_DESC_LOGISTICDRIVER = 'Logistic Driver';
    const MANPOWER_DL_DESC_SCAFFOLDER = 'Scaffolder';


    public function listManpowerDL($name="id") {
        if ($name=="id")
            return array(
                self::MANPOWER_DL_FOREMAN, 
                self::MANPOWER_DL_FITTER, 
                self::MANPOWER_DL_WELDER, 
                self::MANPOWER_DL_HELPER, 
                self::MANPOWER_DL_CARPENTER, 
                self::MANPOWER_DL_FACILITY, 
                self::MANPOWER_DL_LOGISTICDRIVER, 
                self::MANPOWER_DL_SCAFFOLDER, 
            );
        else
        return array(
            self::MANPOWER_DL_DESC_FOREMAN, 
            self::MANPOWER_DL_DESC_FITTER, 
            self::MANPOWER_DL_DESC_WELDER, 
            self::MANPOWER_DL_DESC_HELPER, 
            self::MANPOWER_DL_DESC_CARPENTER, 
            self::MANPOWER_DL_DESC_FACILITY, 
            self::MANPOWER_DL_DESC_LOGISTICDRIVER, 
            self::MANPOWER_DL_DESC_SCAFFOLDER, 
        );
    }

    public function listJabatanManpower($name="id") {
        if ($name=="id")
            return array(
                self::MANPOWER_IDL_PROJECTMANAGER, 
                self::MANPOWER_IDL_PROJECTENGINEER, 
