...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('tbprojectmanpower', function (Blueprint $table) {
            $table->id('projectmanpowerid')->autoIncrement();
            $table->foreignId('manpowerid');
    ...
    {
        Schema::dropIfExists('tbprojectmanpower');
    }
};
