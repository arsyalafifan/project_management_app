...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('tbprojectprogress', function (Blueprint $table) {
            $table->id('projectprogressid')->autoIncrement();
            $table->foreignId('projectid');
            $table->integer('qtymaterial');
            $table->date('tgldari');
    ...
    {
        Schema::dropIfExists('tbprojectprogress');
    }
};
