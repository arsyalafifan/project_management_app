    ...
    <div id="wrapper">
                ...
                <ul class="nav navbar-top-links navbar-left hidden-xs">
                    <li>
                        <a href="javascript:void(0)" class="logotext">
                            <!--This is logo text-->Project Management Apps</a>
                    </li>
                </ul>
                <!-- /.Logo -->
                <!-- top right panel -->
                    ...
                    <li> 
                        ...
                        {{-- <ul aria-expanded="false" class="collapse"> --}}
                            ...
                            <div class="sidebarmenu">
                                ...
                                <ul class="sidebar-menu">
                                    <li>
                                        <a class="waves-effect waves-dark" href="{{-- route('') --}}">Halaman Awal</a>
                                    </li>
                                </ul>
                            </div>
                            {{-- <li>
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <!-- .row -->
                <div class="row bg-title" style="box-shadow: inset 0 0 0 2000px rgba(0, 0, 0, 0.3);">
            ...
            <footer class="footer text-center">
                ...
                <div class="d-flex">
                    ...
                    <div class="ml-auto">
                    © 2024 {{ config('app.name', '') }} by {{ apps::gettemplate($mode, 'comp_name') }}
                    </div>
                </div>
                @else
                © 2024 {{ config('app.name', '') }} by {{ apps::gettemplate($mode, 'comp_name') }}
