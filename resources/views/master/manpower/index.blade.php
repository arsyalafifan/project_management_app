        ...
        var manpowertable = $('#manpower-table').DataTable({
            ...
            buttons: {
                buttons: [{
                    ...
                    action: function () {
                        ...
                        var url = "{{ route('manpower.show', ':id') }}"
                    ...
                    action: function () {
                        ...
                        var url = "{{ route('manpower.edit', ':id') }}"
                        url = url.replace(':id', id);
                        window.location = url;
                    }
                }, {
                    ...
                    action: function () {
                        ...
                        var url = "{{ route('manpower.destroy', ':id') }}"
                        url = url.replace(':id', id);
                        var nama = manpowertable.rows({
                            selected: true
                        }).data()[0]['nama'];
                        swal.fire({
                            title: "Apakah anda yakin akan menghapus manpower " + nama +
                                "?",
                            icon: 'warning',
            ...
            columns: [
                ...
                {'orderData': 2, data: 'jabatan',
                    render: function ( data, type, row ) {
                        if(row.jabatan != null) {
                            var listJabatanManpower = @json($listJabatanManpowerDesc);
                            let Desc;
                            listJabatanManpower.forEach((value, index) => {
