                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <select id="grup" class="col-md-12 custom-select form-control" name='grup' autofocus {{ $akses->exists ? 'disabled' : '' }}>
                                        ...
                                        <option @if (old("grup", $akses->grup)==enum::USER_ADMIN) selected @endif value="{{enum::USER_ADMIN}}">{{ 'Admin' }}</option>
                                        <option @if (old("grup", $akses->grup)==enum::USER_PM) selected @endif value="{{enum::USER_PM}}">{{ 'Project Manager' }}</option>
                                        <option @if (old("grup", $akses->grup)==enum::USER_ADMPROYEK) selected @endif value="{{enum::USER_ADMPROYEK}}">{{ 'Admin Proyek' }}</option>
                                        <option @if (old("grup", $akses->grup)==enum::USER_SUPERVISOR) selected @endif value="{{enum::USER_SUPERVISOR}}">{{ 'Supervisor' }}</option>
                                    </select>
                                </div>
                            </div>
                            <div class="row">
