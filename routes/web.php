...
use App\Http\Controllers\master\ManpowerController;
...
use App\Http\Controllers\progressproject\ProjectController;
...
Route::middleware(['auth'])->group(function () {
    ...
    // Master Kelas
     ...
     // Project
     Route::post('project/selesai/{id}', [ProjectController::class,'selesai'])->name('project.selesai');
     Route::post('project/destroyprogresproject/{id}', [ProjectController::class,'destroyprogresproject'])->name('project.destroyProgresproject');
     Route::post('project/destroymanpower/{id}', [ProjectController::class,'destroymanpoweproject'])->name('project.destroyManpower');
     Route::post('project/storeprojectprogress', [ProjectController::class,'storeProjectprogess'])->name('project.storeProjectprogess');
     Route::post('project/storemanpower', [ProjectController::class,'storeManpower'])->name('project.storeManpower');
     Route::get('project/loadmanpower/{projectid}', [ProjectController::class,'loadManpower'])->name('project.loadManpower');
     Route::get('project/loadprogress/{projectid}', [ProjectController::class,'loadProgress'])->name('project.loadProgress');
